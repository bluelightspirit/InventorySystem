# InventorySystem
## A Java game that uses the terminal where the player tries to go for as much value or strength as possible by adding items to their inventory that have randomized values & strengths
